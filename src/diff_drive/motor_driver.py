...
class VelocityCommand():
    ...
    def set_pwm(self, data: Twist): 
        ...
        left_speed_percent = (100 * left_speed/self.max_speed) #float(min(max(abs(left_speed * 1), 0.4), max_speed))
        right_speed_percent = (100 * right_speed/self.max_speed) #float(min(max(abs(right_speed * 1), 0.4), max_speed))
